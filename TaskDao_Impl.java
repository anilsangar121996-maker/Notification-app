  ...
  public TaskDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTask = new EntityInsertionAdapter<Task>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `tasks` (`id`,`title`,`description`,`timeMillis`,`isCompleted`) VALUES (nullif(?, 0),?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement, final Task entity) {
        ...
        statement.bindLong(4, entity.timeMillis);
    ...
    this.__updateAdapterOfTask = new EntityDeletionOrUpdateAdapter<Task>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `tasks` SET `id` = ?,`title` = ?,`description` = ?,`timeMillis` = ?,`isCompleted` = ? WHERE `id` = ?";
      }
  ...
  public List<Task> getAllTasks() {
    ...
    try {
      ...
      while (_cursor.moveToNext()) {
        ...
        _item = new Task(_tmpTitle,_tmpDescription,_tmpTimeMillis);
